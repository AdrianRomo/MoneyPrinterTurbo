"""检查 Influencer-Automation 2.0 是否存在可用的新正式版本。"""
...
LATEST_RELEASE_API_URL: Final = (
    "https://api.github.com/repos/AdrianRomo/Influencer-Automation-2.0/releases/latest"
)
LATEST_RELEASE_PAGE_URL: Final = (
    "https://github.com/AdrianRomo/Influencer-Automation-2.0/releases/latest"
)
...
RELEASE_CHECK_HEADERS: Final = {
    ...
    "User-Agent": "Influencer-Automation-2.0-Version-Checker",
}
...
def get_available_update(current_version: str) -> str | None:
    ...
    logger.info(
        "Influencer-Automation 2.0 update available: "
...
class AsyncUpdateChecker:
    ...
    def _run_check(self, current_version: str) -> None:
        try:
            ...
            logger.exception(
                "unexpected error while checking for a Influencer-Automation 2.0 update"
            )
